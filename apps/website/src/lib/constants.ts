...
export const DATABASE_MIGRATIONS_PATH = env.PUBLIC_DATABASE_MIGRATIONS_PATH ?? "src/features/db/migrations"
export const ORIGIN = env.PUBLIC_ORIGIN ?? `https://localhost:5173`
export const ORIGIN_API = `${ORIGIN}/api/v1`
export const TERRAFORM_CLI_CLIENT_ID = "terraform-cli"